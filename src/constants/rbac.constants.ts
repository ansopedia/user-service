...
export const defaultPermissions: CreatePermission[] = [
  // User Management Permissions
  {
    ...
    description: "Allows authorized users to create new user accounts, assign roles, and initialize user profiles securely within the system.",
  ...
  },
  {
    ...
    description: "Grants the ability to view user accounts, including names, roles, and activity information for administrative review or audit.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Allows modification of user details such as personal data, assigned roles, or account settings within authorized scope.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Authorizes the permanent removal or deactivation of user accounts from the system by an admin or system manager.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Allows restoring previously deleted or deactivated user accounts, reinstating all related roles and access rights.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  // Role Management Permissions
  {
    ...
    description: "Grants permission to create new roles and define sets of permissions for different types of system users.",
  ...
  },
  {
    ...
    description: "Allows viewing available roles in the system, including their assigned permissions and related access policies.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Allows editing existing roles, modifying their names, permissions, or descriptions as per system requirements.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Permits deletion or deactivation of existing roles that are no longer required in the system configuration.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Allows restoring previously deleted or inactive roles along with their permission mappings for reuse.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  },
  {
    ...
    description: "Grants visibility into which permissions are assigned to specific roles within the system configuration.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  {
    ...
    description: "Allows modifying role-permission relationships by adding or removing specific permissions from a role.",
    category: PermissionCategory.ROLE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  // User-Role Management Permissions
  {
    ...
    description: "Allows creating new user-role assignments, linking users to specific system roles for access control.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  },
  {
    ...
    description: "Allows authorized updates to a user's assigned roles, adjusting their permissions dynamically as needed.",
    category: PermissionCategory.USER_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  // Course Management Permissions
  {
    ...
    description: "Allows authorized users to create new courses, define structure, and upload related learning materials.",
  ...
  },
  {
    ...
    description: "Grants access to view available courses, including details, instructors, and learning content overview.",
    category: PermissionCategory.COURSE_MANAGEMENT,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
  ...
  // Permission Management Permissions
  {
    ...
    description: "Allows viewing all available system permissions for audit, documentation, or configuration review purposes.",
    category: PermissionCategory.SYSTEM,
    createdBy: systemUserObjectId,
    isDeleted: false,
  },
