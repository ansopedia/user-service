...
export const PASSWORD_RESET_ERRORS: ErrorMessagesGroup = {
  INVALID_PASSWORD_RESET_TOKEN_ERROR:
    'Invalid password reset token. Please check your email and try again.',
  PASSWORD_RESET_TOKEN_EXPIRED_ERROR:
    'Password reset token has expired. Please check your email and try again.',
};
...
export const USER_LOGIN_ERRORS: ErrorMessagesGroup = {
  ...
  TOO_MANY_FAILED_ATTEMPTS_ERROR:
