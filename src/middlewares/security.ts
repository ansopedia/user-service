...
//     riskScore += 20;
//   } else if ((req.deviceInfo.screen.width ?? 0) > 10000 || (req.deviceInfo.screen.height ?? 0) > 10000) {
...
//     const isRevoked = await AuthService.isTokenRevoked(payload.sessionId as string, payload.tokenVersion as number);
